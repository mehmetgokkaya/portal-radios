...
var _bgCovers = __webpack_require__(39);

var _bgCovers2 = _interopRequireDefault(_bgCovers);

var _menuOffcanvas = __webpack_require__(40);

var _menuOffcanvas2 = _interopRequireDefault(_menuOffcanvas);
...
(0, _bgCovers2.default)();
(0, _menuOffcanvas2.default)();
...
exports.default = function () {
    var data = document.querySelectorAll('[data-bgcover]');

    if (data) {
        data.forEach(function (element) {
            var bg = element.getAttribute('data-bgcover');
...
exports.default = function () {
    var toggleOffcanvas = document.querySelectorAll('.toggle-offcanvas');

    if (toggleOffcanvas.length >= 1) {
        toggleOffcanvas.forEach(function (item) {
            item.addEventListener('click', function (e) {
                e.preventDefault();
                var menuOffcanvas = document.querySelector('.menu-offcanvas');
                var closeOffcanvas = document.querySelector('.close-menu-offcanvas');
